...
README
  ...
  "RNA-seq and Tn-seq reveal fitness determinants of vancomycin-resistant Enterococcus faecium during 
...
GIT
  ...
  The file created in from the HTseq sbatch job need to be cut wiiht the folloing code
``` 
